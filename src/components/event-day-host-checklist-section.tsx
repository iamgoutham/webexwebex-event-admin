...
function VirtualChecklistList() {
  return (
    <ul className="list-none space-y-3 text-sm text-[#6b4e3d]">
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>1</span><span>Turn off all notifications, log in to the Webex app, and start your meeting.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>2</span><span>Identify a co-host from your participants.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>3</span><span>Guide the co-host through setup.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>4</span><span>Ensure your layout is in grid mode.</span></li>
      ...
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>10</span><span>At chanting start time, click <span className="font-medium text-[#3b1a1f]">Stop Video</span>, then immediately <span className="font-medium text-[#3b1a1f]">Start Video</span>, so the pacer video restarts from the beginning.</span></li>
...
function MobileChecklistList() {
  return (
    <ul className="mt-4 list-none space-y-3 text-sm text-[#6b4e3d]">
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>1</span><span>Turn off all notifications, log in to the Webex app, and start your meeting.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>2</span><span>Prepare the mobile device (phone): turn on Do Not Disturb, mute notifications, and set screen timeout to Never.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>3</span><span>Join your meeting from the mobile device as a participant (without signing in to Webex), set Don&apos;t Connect Audio, then share the entire screen and display the Pacer Video in horizontal format.</span></li>
      ...
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>8</span><span>Lock the meeting and disable Participant privileges under Meeting Options. For chanting #1, lock at 10:10 am EDT / 9:10 am CDT / 7:10 am PDT / 7:40 pm IST.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>9</span><span>Open the OBS app (setup ready), start recording just before chanting start time, then minimize OBS.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>10</span><span>At chanting start time, play the pacer video from the beginning.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>11</span><span>After chanting, open OBS, stop recording, and minimize OBS.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>12</span><span>Unlock the meeting after chanting #1 so anyone who missed it can join.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>13</span><span>For chanting #2, lock at 10:30 am EDT / 9:30 am CDT / 7:30 am PDT / 8:00 pm IST.</span></li>
      <li className="flex gap-3"><span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-[#d8792d]/25 text-xs font-bold text-[#7a3b2a]" aria-hidden>14</span><span>Repeat steps 9-11 for chanting #2.</span></li>
    ...
    <div className={standalone ? "mt-4" : "mt-8 border-t border-[#e5c18e]/80 pt-8"}>
      {standalone ? (
        <h2 className="text-xl font-bold leading-snug text-[#3b1a1f] sm:text-2xl">
          Event day Host Checklist (For Pacer Video shared from Mobile device)
        </h2>
      ) : (
      ...
      <a
        href="https://docs.google.com/document/d/1UTe58-110Ak2NwtQt_VPBdjrejgRwWg6z6eaSJH9hDE/edit?tab=t.rtoxfhie2htp"
        target="_blank"
        rel="noreferrer"
      ...
      {mode !== "mobile" ? (
        <>
          ...
          {showSharedIntro ? (
            <>
              <p className="mt-2 text-sm leading-relaxed text-[#6b4e3d]">
                Chinmaya Gita Samarpanam — event day host checklist for the day
                of the event (reference date: May 9, 2026). Trial sessions on
                April 25 and May 2 use the same format as the final session.
              </p>
              <p className="mt-2 text-sm leading-relaxed text-[#6b4e3d]">
                We record the chanting two times so there is a backup.
              </p>
